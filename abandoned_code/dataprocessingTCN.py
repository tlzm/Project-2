# -*- coding: utf-8 -*-
"""
Created on Fri Oct  2 09:35:26 2020
...
RUL_01 = np.loadtxt('./cmapss/RUL_FD001.txt')

train_01_raw = np.loadtxt('./cmapss/train_FD001.txt')

test_01_raw = np.loadtxt('./cmapss/test_FD001.txt')
...
winSize = 30 # FD001: 40; FD002: 50; FD003: 40; FD004:50
