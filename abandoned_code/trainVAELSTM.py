...
model.add(LSTM(units=256, return_sequences=True,recurrent_dropout=0.2,name="lstm_0"))
...
model.compile(loss='mse', optimizer='rmsprop', metrics=[root_mean_squared_error, exps,'mae', score_calc])
#'binary_crossentropy'
print(model.summary())
